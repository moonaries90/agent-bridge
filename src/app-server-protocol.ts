...
/**
 * turn/steer injects input into a CURRENTLY ACTIVE turn (vs. turn/start, which
 * begins a new turn and is rejected while a turn is running). `expectedTurnId`
 * is a precondition — the request fails if it doesn't match the active turn.
 */
