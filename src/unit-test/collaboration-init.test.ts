...
describe("writeCollaborationSections", () => {
  ...
  test("creates CLAUDE.md and AGENTS.md when they don't exist", () => {
    ...
    // Peer-side content refers to the driver generically (not hardcoded "Claude"),
    // since the controller may be Claude or Codex depending on the launch command.
    expect(agents).toContain("the controller");
